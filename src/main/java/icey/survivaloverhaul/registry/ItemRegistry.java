...
public class ItemRegistry
{
	...
	public static final RegistryObject<Item> MERCURY_PASTE = ITEMS.register("mercury_paste", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MATERIALS)));
	public static final RegistryObject<Item> THERMOMETER = ITEMS.register("thermometer", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_TOOLS)));
	...
	// Block Items
	public static final RegistryObject<Item> CINNABAR_ORE_ITEM = ITEMS.register("cinnabar_ore", () -> new BlockItem(BlockRegistry.CINNABAR_ORE.get(), new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS)));
	
	public static final RegistryObject<Item> COOLING_COIL_ITEM = ITEMS.register("cooling_coil", () -> new BlockItem(BlockRegistry.COOLING_COIL.get(), new Item.Properties().tab(ItemGroup.TAB_REDSTONE)));
	public static final RegistryObject<Item> HEATING_COIL_ITEM = ITEMS.register("heating_coil", () -> new BlockItem(BlockRegistry.HEATING_COIL.get(), new Item.Properties().tab(ItemGroup.TAB_REDSTONE)));
	
	public static final RegistryObject<Item> TEMERATURE_SENSOR_ITEM = ITEMS.register("temperature_sensor", () -> new BlockItem(BlockRegistry.TEMERATURE_SENSOR.get(), new Item.Properties().tab(ItemGroup.TAB_REDSTONE)));
}